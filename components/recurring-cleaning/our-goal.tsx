          ...
          <div className="md:w-1/2">
            <div className="max-w-lg">
              ...
              <p className="text-gray-600 mb-6">
                With our recurring cleaning service, we aim to give you consistently excellent results
                that exceed your expectations every time. Our reliable team will maintain your space to the
                highest standards on a schedule that works for you.
              </p>
              <Link
                href="/book-now"
