...
const ServiceOption = ({ name, href, active }: ServiceOptionProps) => {
  return (
    <div>
      <Link href={href} className={`flex items-center justify-between p-3 rounded-lg border ${active ? 'bg-green-50 border-green-200' : 'border-gray-100 hover:bg-gray-50'} transition-all hover:translate-x-1`}>
...
export const RecurringServiceSidebar = () => {
  return (
    <div className="space-y-6 sticky top-4">
      ...
      <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:-translate-y-1 transition-transform">
        ...
        <div className="space-y-3">
          ...
          <ServiceOption name="Recurring Cleaning" href="/services/recurring-cleaning" active />
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:-translate-y-1 transition-transform">
        <div className="flex justify-center mb-3">
          <div className="hover:scale-105 transition-transform">
            <Image 
              ...
              alt="Recurring cleaning services"
              width={200}
              height={150}
        ...
        <div className="text-center">
          <h3 className="font-semibold text-gray-900 mb-2">
            Looking for regular cleaning service today?
          </h3>
      ...
      <div className="bg-yellow-100 p-6 rounded-xl hover:-translate-y-1 transition-transform">
        <h3 className="font-semibold text-gray-900 mb-2">
          Check out our FAQ for all the details and reasons you need...
        </h3>
        <button className="mt-3 bg-green-600 hover:bg-green-700 text-white text-sm font-medium py-2 px-4 rounded-md w-full transition-all hover:scale-[1.03] active:scale-[0.97]">
          Read More
        </button>
      </div>
    </div>
