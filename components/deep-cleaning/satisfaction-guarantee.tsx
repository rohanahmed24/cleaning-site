...
export const DeepSatisfactionGuarantee = () => {
  return (
    <div className="bg-white p-6 rounded-xl shadow-md h-full flex flex-col">
      <div>
        ...
        <p className="text-gray-700 mb-6">
          If you aren't completely satisfied with our deep cleaning service, we'll return and re-clean any areas at no extra charge. We're committed to delivering the most thorough deep cleaning possible.
        </p>
      </div>
      ...
      <div className="mt-auto">
        ...
        <div className="flex items-center mt-4">
          ...
          <div>
            ...
            <div className="text-sm text-gray-600">Based on 1,800+ reviews</div>
          </div>
        </div>
      </div>
    </div>
