          ...
          <div className="md:w-1/2">
            <div className="max-w-lg">
              ...
              <p className="text-gray-600 mb-6">
                We're committed to delivering the highest quality deep cleaning services that exceed your expectations. 
                Our professional cleaners are trained to tackle even the most stubborn dirt and grime in your home.
              </p>
              <Link
                href="/book-now"
