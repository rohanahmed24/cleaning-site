...
export const PostConstructionOurGoal = () => {
  const locations = [
          ...
          <div className="md:w-1/2">
            <div className="max-w-lg">
              ...
              <p className="text-gray-600 mb-6">
                We're committed to transforming your post-construction space into a pristine, move-in ready environment. 
                Our professional cleaners are specially trained to handle the unique challenges of construction cleanup.
              </p>
              <Link
                href="/book-now"
