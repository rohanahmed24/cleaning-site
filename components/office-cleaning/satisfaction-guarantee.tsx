...
export const OfficeSatisfactionGuarantee = () => {
  return (
    <div className="bg-white p-6 rounded-xl shadow-md h-full flex flex-col">
      <div>
        ...
        <p className="text-gray-700 mb-6">
          If your office isn't completely spotless after our service, we'll return and re-clean any areas at no extra charge.
        </p>
      </div>
      ...
      <div className="mt-auto">
        ...
        <div className="flex items-center mt-4">
          ...
          <div>
            ...
            <div className="text-sm text-gray-600">Based on 1,500+ reviews</div>
          </div>
        </div>
      </div>
    </div>
