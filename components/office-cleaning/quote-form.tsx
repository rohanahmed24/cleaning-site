...
export const OfficeQuoteForm = () => {
  return (
    <div className="bg-yellow-100 p-6 rounded-xl">
      <h3 className="text-xl font-semibold mb-4 text-gray-900">Get Your Free Quote</h3>
      ...
      <form className="space-y-4">
        ...
        <div>
          <label htmlFor="office-size" className="block text-sm font-medium text-gray-700 mb-1">Office Size (sq ft)</label>
          <select 
            id="office-size" 
            className="w-full p-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
          >
