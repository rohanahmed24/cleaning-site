...
export const MoveInOutServiceSidebar = () => {
  return (
    <div className="space-y-6 sticky top-4" style={{opacity: 1}}>
      ...
      <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:-translate-y-1 transition-transform">
        ...
        <div className="space-y-3">
          ...
          <ServiceOption name="Move In/Out Cleaning" href="/services/move-in-out-cleaning" active />
      ...
      <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:-translate-y-1 transition-transform">
        <div className="flex justify-center mb-3">
          <div className="hover:scale-105 transition-transform">
            <Image 
              src="https://images.unsplash.com/photo-1605117882932-f9e32b03fea9?auto=format&fit=crop&w=400&q=80"
              alt="Move in/out cleaning supplies"
              width={200}
              height={150}
