          ...
          <div className="md:w-1/2">
            <div className="max-w-lg">
              ...
              <p className="text-gray-600 mb-6">
                We're committed to making your move as stress-free as possible with our thorough cleaning services. 
                Our professional cleaners ensure your old or new home is spotless and ready for the next chapter.
              </p>
              <Link
                href="/book-now"
