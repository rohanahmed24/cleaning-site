        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <motion.div variants={fadeInUp}>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8">Transparent Pricing</h1>
            </motion.div>
      ...
      >
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            variants={fadeInUp}
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Get The Cleanliness you <br />Deserve at a Price You'll Love</h2>
            ...
            >
              <div className="max-w-lg">
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                  <Link
                    href="/contact-us"
                    className="inline-block border border-green-600 text-green-600 hover:bg-green-600 hover:text-white font-medium py-2 px-6 rounded-full transition-colors"
                  >
                    Get In Touch
                  </Link>
                </motion.div>
